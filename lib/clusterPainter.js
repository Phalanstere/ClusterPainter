...
this.clear_dom = function() {
 ...
 this.remove_default = function() {
    ...
    if (events.length > 0)
        ...
        self.greensock_event(events, self.clear_dom);
        }  
...
this.position_carousel = function(job) {
 ...
 this.fadeOut = function() {
     console.log("VOR DEM PAINT IN FADEOUT - OLD JOBS NEHMEN ACTUAL")
     self.old_jobs = self.actual_jobs;
     self.actual_jobs = [];
 ...
 this.paint = function(id) {
  ...
  this.init = function() {
     ...
     if (params.css_class) self.css_class = params.css_class;
     else                  self.css_class = "standard";   
